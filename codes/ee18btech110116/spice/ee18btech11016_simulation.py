...
data=np.loadtxt('ee18btech11016_sim.dat')
...
'''
plt.savefig('./figs/ee18btech11026/ee18btech11016_spice_result.pdf')
plt.savefig('./figs/ee18btech11026/ee18btech11016_spice_result.eps')
